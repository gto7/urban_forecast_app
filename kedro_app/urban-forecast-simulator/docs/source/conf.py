...
# urban_forecast_simulator documentation build
...
from urban_forecast_simulator import __version__ as release

# -- Project information -----------------------------------------------------

project = "urban_forecast_simulator"
author = "Kedro"
...
htmlhelp_basename = "urban_forecast_simulatordoc"
...
latex_documents = [
    (
        master_doc,
        "urban_forecast_simulator.tex",
        "urban_forecast_simulator Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "urban_forecast_simulator",
        "Project urban_forecast_simulator codebase.",
        "Data-Science",
    )
]
